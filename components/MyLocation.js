...
export default class MyLocationMapMarker extends React.PureComponent {
  ...
  watchLocation() {
    this.watchID = navigator.geolocation.watchPosition(
      position => {
        ...
        this.props.getLocation && this.props.getLocation(position.coords)
      },
      null,
  ...
  render() {
    ...
    let {colorMark, ...props} = this.props;
    if (!coordinate) {
        ...
        <View style={styles.container}>
          ...
          {rotate && (
            <View style={[styles.heading, { transform: [{ rotate }] }]}>
              <View style={[styles.headingPointer, {backgroundColor: colorMark}]} />
            </View>
          )}
          <View style={[styles.marker, {backgroundColor: colorMark}]}>
